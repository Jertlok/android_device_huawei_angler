...
#KERNEL_TOOLCHAIN := ./prebuilts/gcc/$(HOST_OS)-x86/aarch64/aarch64-linux-android-4.9/bin
...
BOARD_KERNEL_CMDLINE += loop.max_part=7 maxcpus=4 androidboot.selinux=permissive
